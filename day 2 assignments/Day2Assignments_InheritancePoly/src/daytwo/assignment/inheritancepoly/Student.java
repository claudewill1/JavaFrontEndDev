...
public class Student extends Person{
	static final String CLASS_NAME = "Student";
	static final String FRESHMAN_STATUS = "freshman";
	static final String SOPHOMORE_STATUS = "sophomore";
	static final String JUNIOR_STATUS = "junior";
	static final String SENIOR_STATUS = "senior";
	...
	public Student(String name, String address, String phoneNumber, String emailAddress, String classStatus) {
		...
		switch (classStatus.toLowerCase()) {
			case "freshman":
				this.classStatus = FRESHMAN_STATUS;
				break;
			case "sophomore":
				this.classStatus = SOPHOMORE_STATUS;
				break;
			case "junior":
				this.classStatus = JUNIOR_STATUS;
				break;
			case "senior":
				this.classStatus = SENIOR_STATUS;
				break;
			default:
				break;
		}
	...
	public String toString() {
		return "Class name: " + CLASS_NAME + " Student Name: "+name;
	}
}
